...
<div style={{
  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <img
          src="https://github.com/dxnz-id.png"
          style={{
            width: '70px',
            height: '70px',
          }}
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
      ...
      <span style={{
        ...
        Fullstack Developer · Systems Explorer
      </span>
    </div>
  </div>
  ...
  <div style={{ display: 'flex', gap: '8px' }}>
    {[
      { tag: 'typescript', bg: 'rgba(137,180,250,0.12)', border: '#89b4fa', color: '#89b4fa' },
      { tag: 'nextjs',     bg: 'rgba(166,227,161,0.12)', border: '#a6e3a1', color: '#a6e3a1' },
...
<div style={{
  ...
  {[
    { label: 'Email',     value: 'dxnzid@icloud.com', color: '#a6e3a1', accent: '#a6e3a1' },
    { label: 'Instagram', value: 'dxnz.idx',          color: '#cba6f7', accent: '#cba6f7' },
    { label: 'X',         value: '@dxnz_code',        color: '#89b4fa', accent: '#89b4fa' },
  ].map((item, i, arr) => (
    <div key={i} style={{
      display: 'flex',
      flex: '1',
      ...
      justifyContent: 'center',
      gap: '7px',
      borderRight: i < arr.length - 1 ? '1px solid #313244' : 'none',
      position: 'relative',
      overflow: 'hidden',
    }}>
      <div style={{
